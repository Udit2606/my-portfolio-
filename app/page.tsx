...
function HeroSection() {
  const scrollY = useScrollAnimation()
  const profileImageSrc = "/IMG_9310.jpeg"
      ...
      >
        <div className="animate-fade-in-up">
          <Dialog>
            <DialogTrigger asChild>
              <button
                type="button"
                className="mx-auto mb-6 sm:mb-8 block rounded-full animate-float shadow-2xl ring-4 ring-primary/20 transition-transform duration-300 hover:scale-105 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/40"
                aria-label="Open profile photo"
              >
                <Avatar className="w-32 h-32 sm:w-40 sm:h-40 cursor-zoom-in">
                  <AvatarImage src={profileImageSrc} alt="Profile" style={{ objectFit: "cover" }} />
            ...
            <DialogContent className="max-w-4xl border-primary/20 bg-background/95 p-3 sm:p-4">
              <DialogTitle className="sr-only">Profile photo</DialogTitle>
              <DialogDescription className="sr-only">Expanded view of Udit Mittal&apos;s profile photo.</DialogDescription>
              <img
                src={profileImageSrc}
                alt="Udit Mittal portrait"
        ...
        >
          ...
          <Button
            ...
            onClick={() => window.open("https://drive.google.com/file/d/1GK4PDVFBRMyyxE_eXsnel4zxF5SZAj25/view?usp=drive_link", "_blank")}
          >
